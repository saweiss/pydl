# -*- coding: utf-8 -*-
#
# PyDL documentation build configuration file, created by
...
project = u'PyDL'
copyright = u'2018, Samuel A. Weiss'
...
latex_documents = [
  ('index', 'pydl.tex', u'PyDL Documentation',
   u'Samuel A. Weiss', 'manual'),
]
...
man_pages = [
    ('index', 'pydl', u'PyDL Documentation',
     [u'Samuel A. Weiss'], 1)
]
